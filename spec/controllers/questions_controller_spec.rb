...
let(:my_question) { Question.create!(title: "New Question Title", body: "New Question Body", resolved: true) }
  ...
  describe "POST #create" do
    it "increases the number of Question by 1" do
      expect{post :create, question: {title: "New Question Title", body: "New Question Body", resolved: true}}.to change(Question, :count).by(1)
    end

    it "assigns the new question to @question" do
      post :create, question: {title: "New Question Title", body: "New Question Body", resolved: true}
  ...
  describe "PUT #update" do
    it "updates question with expected attributes" do
      ...
      expect(updated_question).to eq my_question
