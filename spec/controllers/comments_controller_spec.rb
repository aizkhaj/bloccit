...
RSpec.describe CommentsController, type: :controller do
  ...
  # We create specs for guest users, who we will redirect to sign in if they attempt to create or delete a comment.
  context "guest" do
  ...
  # We will allow members to create new comments, but redirect them to posts show view if they try to delete another user's comments.
  ...
  # members are able to create new and delete comments.
  ...
  # Admins are able to create and delete any comment, regardless of owner.
